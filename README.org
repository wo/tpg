...
I also hope to make better use of the free-variable machinery outside S5 in the
future. (At a minimum: when applying the seriality rule, we could use a new
world /variable/.)
